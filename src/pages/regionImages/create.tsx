...
import { IRegion, IType } from "interfaces";
import axios from "axios";
import { ColorRing } from "react-loader-spinner";

export const RegionImageCreate: React.FC<IResourceComponentsProps> = () => {
  ...
  const handleClick = async () => {
    ...
    formData.append("imageCategory", "Region");
  ...
  return (
    <Create saveButtonProps={{ ...saveButtonProps, onClick: handleClick }}>
      ...
      <Form {...formProps} layout="vertical">
        ...
        >
          <Select {...regionSelectProps} onChange={(e) => setSubCategory(e)} />
        </Form.Item>
